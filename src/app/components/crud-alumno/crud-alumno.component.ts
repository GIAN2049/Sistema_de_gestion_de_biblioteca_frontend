...
export class CrudAlumnoComponent {
  ...
  //Cabecera
  displayedColumns = ["idAlumno","nombres","apellidos","telefono","celular","dni","correo","tipoSangre","fechaNacimiento","pais","modalidad","estado", "acciones"];
  

  filtro: string = "";
  
  constructor(private dialogService: MatDialog, private alumnoService: AlumnoService) { }
